  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-zinc-950 text-white">
      <div className="p-4 sm:p-6 border-b border-zinc-800 shrink-0">
        <h1 className="text-xl sm:text-2xl font-bold tracking-tight">{workspace.name}</h1>
        <p className="text-sm text-zinc-500 mt-1">Select a channel to start chatting</p>
      </div>
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="flex flex-col items-center text-center max-w-sm animate-fade-in">
          ...
          <h2 className="text-xl font-semibold text-zinc-300 mb-2">Welcome to {workspace.name}</h2>
          <p className="text-sm text-zinc-500 leading-relaxed mb-6">Choose a channel from the sidebar to start collaborating with your team.</p>
